...
const SaleOriginal: React.FC<SaleOriginalProps> = props => {
    ...
    },
    {
      ...
      render: (text, record, _, action) => [
        <a
          ...
          onClick={() =>
            history.push(
              `/dataManagement/dailyDataManagement/originalDataManagement/saleOriginal/detail/${record.id}?sourceTabIndex=1&sourcePage=/dataManagement/dailyDataManagement/originalDataManagement`,
            )
          }
        >
          查看
        </a>,
        <Authorized code={'dayOriginSale-delete'}>
          <Popconfirm
  ...
  const exportData = () => {
    setLoading(true);
    const params = Object.assign(searchParams, { erpFlag: 0 });
      ...
      <div>
        <div className="search-result-list">
          <Table<GithubIssueItem>
            code="dataManage-day-saleOriginal"
            saveSearchValue
            tableAlertRender={false}
            columns={columns}
            rowSelection={{
            ...
            headerTitle={
              <Space>
                {selectedRowKeys.length === 0 ? (
                  <Authorized code={'dayOriginSale-batDel'}>
                ...
                <Authorized code={'dayOriginSale-export'}>
