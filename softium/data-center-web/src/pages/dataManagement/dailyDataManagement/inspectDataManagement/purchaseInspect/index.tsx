...
const PurchaseInspect: React.FC<PurchaseInspectProps> = props => {
    ...
    },
    {
      ...
      render: (text: any, record: any, index: any) => [
        <a
          ...
          onClick={() =>
            history.push(
              `/dataManagement/dailyDataManagement/inspectDataManagement/purchaseInspect/detail/${record.id}?sourceTabIndex=2&sourcePage=/dataManagement/dailyDataManagement/inspectDataManagement`,
            )
          }
        >
          查看
  ...
  const purchaseInspectExport = () => {
    ...
    getPurchaseInspectDataExportRequest(searchParams).then((res: any) => {
      downloadFile(res);
      setTimeout(() => {
  ...
  //全部数据清洗
  const allDataClean = () => {
    const params = { businessType: 'PD', periodId: '' };
      ...
      <div>
        <div className="search-result-list">
          <Table<GithubIssueItem>
            code="dataManage-day-purchaseInspect"
            saveSearchValue
            ...
            headerTitle={
              <Space>
                <Authorized code={'dayInsPurch-allClean'}>
                  <Button
                    type="primary"
                    key={'export'}
                    disabled={cleanBtn}
                ...
                <Authorized code={'dayInsPurch-export'}>
                  <Button
                    type="default"
                    key={'export'}
