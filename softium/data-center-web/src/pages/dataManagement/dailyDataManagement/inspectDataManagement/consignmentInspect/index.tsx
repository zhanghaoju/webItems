...
const ConsignmentInspect: React.FC<ConsignmentInspectProps> = props => {
    ...
    },
    {
      ...
      render: (text: any, record: any, index: any) => [
        <a
          ...
          onClick={() =>
            history.push(
              `/dataManagement/dailyDataManagement/inspectDataManagement/consignmentInspect/detail/${record.id}?sourceTabIndex=4&sourcePage=/dataManagement/dailyDataManagement/inspectDataManagement`,
            )
          }
        >
          查看
  ...
  //全部数据清洗
  const allDataClean = () => {
    const params = { businessType: 'DD', periodId: '' };
      ...
      <div>
        <div className="search-result-list">
          <Table<GithubIssueItem>
            code="dataManage-day-consignmentInspect"
            saveSearchValue
            ...
            headerTitle={
              <Space>
                <Authorized code={'dayInsConsign-allClean'}>
                  <Button
                    type="primary"
                    key={'export'}
                    disabled={cleanBtn}
                ...
                <Authorized code={'dayInsConsign-export'}>
                  <Button
                    type="default"
                    key={'export'}
