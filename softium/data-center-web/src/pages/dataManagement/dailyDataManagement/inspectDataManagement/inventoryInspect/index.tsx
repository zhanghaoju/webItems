...
const InventoryInspect: React.FC<InventoryInspectProps> = props => {
    ...
    },
    {
      ...
      render: (text: any, record: any, index: any) => [
        <a
          ...
          onClick={() =>
            history.push(
              `/dataManagement/dailyDataManagement/inspectDataManagement/inventoryInspect/detail/${record.id}?sourceTabIndex=3&sourcePage=/dataManagement/dailyDataManagement/inspectDataManagement`,
            )
          }
        >
          查看
  ...
  const purchaseInspectExport = () => {
    ...
    getInventoryInspectDataExportRequest(searchParams).then((res: any) => {
      downloadFile(res);
      setTimeout(() => {
  ...
  //全部数据清洗
  const allDataClean = () => {
    const params = { businessType: 'ID', periodId: '' };
      ...
      <div>
        <div className="search-result-list">
          <Table<GithubIssueItem>
            code="dataManage-day-inventoryInspect"
            saveSearchValue
            ...
            headerTitle={
              <Space>
                <Authorized code={'dayInsInve-allClean'}>
                  <Button
                    type="primary"
                    key={'export'}
                    disabled={cleanBtn}
                ...
                <Authorized code={'dayInsInve-export'}>
                  <Button
                    type="default"
                    key={'export'}
