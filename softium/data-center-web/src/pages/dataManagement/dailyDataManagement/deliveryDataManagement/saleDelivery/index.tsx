    ...
    },
    {
      ...
      render: (text: any, record: any, index: any) => [
        <a
          ...
          onClick={() =>
            history.push(
              `/dataManagement/dailyDataManagement/deliveryDataManagement/saleDelivery/detail/${record.id}?sourceTabIndex=1&sourcePage=/dataManagement/dailyDataManagement/deliveryDataManagement`,
            )
          }
        >
          查看
      ...
      <div>
        <div className="search-result-list">
          <Table<GithubIssueItem>
            code="dataManage-day-saleDelivery"
            saveSearchValue
            ...
            headerTitle={
              <Space>
                <Authorized code={'dayDelSale-export'}>
                  <Button
                    type="primary"
                    key={'export'}
