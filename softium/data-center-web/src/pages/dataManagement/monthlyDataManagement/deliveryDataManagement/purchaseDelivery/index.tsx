...
const PurchaseDelivery: React.FC<PurchaseDeliveryProps> = props => {
    ...
    },
    {
      ...
      render: (text: any, record: any, index: any) => [
        <a
          ...
          onClick={() =>
            history.push(
              `/dataManagement/monthlyDataManagement/deliveryDataManagement/purchaseDelivery/detail/${record.id}?sourceTabIndex=2&sourcePage=/dataManagement/monthlyDataManagement/deliveryDataManagement`,
            )
          }
        >
          查看
  ...
  const purchaseInventoryExport = (filter: any) => {
    ...
    getPurchaseDeliveryDataExportRequest(params).then((res: any) => {
      downloadFile(res);
      setTimeout(() => {
      ...
      <div>
        <div className="search-result-list">
          <Table<GithubIssueItem>
            code="dataManage-month-purchaseDelivery"
            saveSearchValue
            ...
            request={(params, sort, filter) => {
              return getPurchaseDeliveryList({
            ...
            headerTitle={
              <Space>
                <Authorized code={'monthDelPurch-export'}>
                  <Button
                    type="primary"
                    key={'export'}
                ...
                <Authorized code={'monthDelPurch-seal'}>
                  <Button
                    type="default"
                    key={'export'}
                    disabled={
          ...
          <Modal
            ...
            footer={[
              ...
              <Button
                type="primary"
                htmlType="button"
                onClick={() => purchaseInventoryExport({})}
                loading={exportLoading}
              >
                导出
              </Button>,
