...
const ConsignmentDelivery: React.FC<ConsignmentDeliveryProps> = props => {
  ...
  useEffect(() => {
    ...
    getUntreatedPeriod().then((res: any) => {
      if (res && res.success === true) {
        setSealPeriodName(res.data.periodName);
    ...
    },
    {
      ...
      render: (text: any, record: any, index: any) => [
        <a
          ...
          onClick={() =>
            history.push(
              `/dataManagement/monthlyDataManagement/deliveryDataManagement/consignmentDelivery/detail/${record.id}?sourceTabIndex=4&sourcePage=/dataManagement/monthlyDataManagement/deliveryDataManagement`,
            )
          }
        >
          查看
  ...
  //导出
  const consigmentInspectExport = (filter: any) => {
      ...
      <div>
        <div className="search-result-list">
          <Table<GithubIssueItem>
            code="dataManage-month-consignmentDelivery"
            saveSearchValue
            ...
            headerTitle={
              <Space>
                <Authorized code={'monthDelConsign-export'}>
                  <Button
                    type="primary"
                    key={'export'}
                ...
                <Authorized code={'monthDelConsign-seal'}>
                  <Button
                    type="default"
                    key={'export'}
                    disabled={
                ...
                <Authorized code={'monthDelConsign-count'}>
                  <Popconfirm
          ...
          <Modal
            ...
            footer={[
              ...
              <Button
                type="primary"
                htmlType="button"
                onClick={() => consigmentInspectExport({})}
                loading={exportLoading}
              >
                导出
              </Button>,
