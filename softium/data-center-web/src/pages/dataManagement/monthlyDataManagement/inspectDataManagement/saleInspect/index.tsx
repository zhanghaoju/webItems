...
const SaleInspect: React.FC<SaleInspectProps> = props => {
    ...
    },
    {
      ...
      render: (text: any, record: any, index: any) => [
        <a
          ...
          onClick={() =>
            history.push(
              `/dataManagement/monthlyDataManagement/inspectDataManagement/saleInspect/detail/${record.id}?sourceTabIndex=1&sourcePage=/dataManagement/monthlyDataManagement/inspectDataManagement`,
            )
          }
        >
          查看
  ...
  //全部数据清洗
  const allDataClean = () => {
    const params = { businessType: 'SM', periodId: '' };
      ...
      <div>
        <div className="search-result-list">
          <Table<GithubIssueItem>
            code="dataManage-month-saleInspect"
            saveSearchValue
            ...
            headerTitle={
              <Space>
                <Authorized code={'monthInsSale-allClean'}>
                  <Button
                    type="primary"
                    key={'export'}
                ...
                <Authorized code={'monthInsSale-export'}>
                  <Button
                    type="default"
                    key={'export'}
