    ...
    },
    {
      ...
      render: (text, record, _, action) => [
        <a
          ...
          onClick={() =>
            history.push(
              `/dataManagement/monthlyDataManagement/originalDataManagement/consignmentOriginal/detail/${record.id}?sourceTabIndex=4&sourcePage=/dataManagement/monthlyDataManagement/originalDataManagement`,
            )
          }
        >
          查看
        ...
        record.isSeal === 'Archive' ? (
          <Authorized code={'monthOrgConsign-delete'}>
      ...
      <div>
        <div className="search-result-list">
          <Table<GithubIssueItem>
            code="dataManage-month-consignmentOriginal"
            saveSearchValue
            tableAlertRender={false}
            columns={columns}
            rowSelection={{
            ...
            headerTitle={
              <Space>
                {selectedRowKeys.length === 0 ? (
                  <Authorized code={'monthOrgConsign-batDel'}>
                    <Button
                      type="primary"
                ...
                <Authorized code={'monthOrgConsign-export'}>
