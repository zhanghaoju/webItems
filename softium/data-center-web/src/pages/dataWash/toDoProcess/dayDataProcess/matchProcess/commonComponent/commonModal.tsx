          ...
          <Row style={{ display: 'flex', justifyContent: 'space-between' }}>
            <Col span={20}>
              ...
              >
                待清洗名称：
                {pageSource === 1
                  ? fatherCurrentData.fromInstitutionName
                  : fatherCurrentData.toInstitutionName}
              </h3>
            </Col>
            <Col span={4}>
              ...
              {/* <Button type="primary" onClick={() => openAddMasterDataModal()}>
                  +企业主数据
                </Button> */}
            </Col>
          </Row>
            ...
            <TabPane tab="企业库推荐" key="1">
              <div className="search-result-list">
                <ProTable<GithubIssueItem, String[]>
                  // code="toDoProcess-day-enterprise"
                  columns={columns}
                  options={false}
                  scroll={{ x: '100%', y: '40vh' }}
                  search={false}
        ...
        >
          ...
          {!!form2.getFieldValue('category') &&
            form2.getFieldValue('type') === 'HealthCare' && (
              <FormItem label="机构子类" name="subCategory">
                <Select
                  onChange={e => {
