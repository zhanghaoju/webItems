...
//经销商匹配
//待办处理--日数据处理--匹配处理-经销商匹配-load
export const getFromInstitutionMatchList = (params?: any) => {
  return request({
    method: 'post',
    url: '/dayMatch/getDayDistribMatch',
    data: {
      ...params,
    },
  }).then((response: any) => {
...
export const smartMatchFunc = (params?: any) => {
  return request({
    method: 'post',
    url: '/dayMatch/dayIndustyMatch',
    data: params,
  });
};

//待办处理--日数据处理--匹配处理-经销商匹配-弹窗列表确认匹配  校验接口
...
//待办处理--日数据处理--匹配处理-经销商匹配-导出
export const exportUnMatchForDay = (params?: any) => {
  return request({
    method: 'post',
    url: '/dayMatch/exportDayDataMatch',
    responseType: 'blob',
    headers: {
...
export const getFromOrganizationMatchList = (params?: any) => {
  return request({
    method: 'post',
    url: '/dayMatch/getDayToInstitutionMatch',
    data: {
      ...params,
    },
  }).then((response: any) => {
...
//产品匹配
//待办处理--日数据处理--匹配处理-产品匹配-左侧列表load
export const getProductMatchList = (params?: any) => {
  return request({
    method: 'post',
    url: '/dayMatch/getDayProductMatch',
    data: {
      ...params,
    },
  }).then((response: any) => {
...
//单位匹配
//待办处理--日数据处理--匹配处理-单位匹配-load
export const getUnitMatchList = (params?: any) => {
  return request({
    method: 'post',
    url: '/dayMatch/getDayProductUnitMatch',
    data: {
      ...params,
    },
  }).then((response: any) => {
